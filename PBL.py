...
Acumulador_L_independência = 0 #Acumulador da lotofácil da independência 
Acumulador_F_0 = 0 #acumulador para concursos finais 0 da lotofácil
Concursos_LF = 0 #contador dos concursos da Lotofácil
...
Outros encargos e taxas legais = 10,01%%{neutro}\n""")                    
                ...
                if int(menu_mega_sena) == 1:
                    ...
                    while not loop_MS.isdigit() or loop_MS == 1 | 2 | 3:
                        print("Digitou errado, tente novamente!")
                        loop_MS = (input("\n1-Reiniciar\n2-Voltar ao Menu principal\n3-Estatísticas indiviual"))
                ...
                if int(menu_mega_sena) == 2:
                    ...
                    if int(loop_MS)  == 3:
                        ...
                        print(f" Mega da virada {Mega_da_Virada:.2f} Reais")
                        print(f" Seguridade Social {Seguridade_social_MS:.2f} Reais")
                        print(f" Fundo Nacional de Cultura {fnc:.2f} Reais")
                        print(f" Comite Olímpico e Paralímpico: {Comite_Olimpico_Paralimpico_MS:.2f} Reais")
                        print(f" Fundo Penintenciário Nacioal: {funpen_MS:.2f} Reais")
                        print(f" Fundo Nacional De Segurança Pública: {fnsp_MS:.2f} Reais")
                        print(f" Custos Operacionais: {Custos_Operacionais_MS:.2f} Reais")
                        print(f" Impostos: {imposto_MS:.2f} Reais")
                        loop_MS = (input("\n1-Reniciar\n2-(Voltar ao Menu principal)\n3-Estatísticas individuais"))
                    while not loop_MS.isdigit() or int(loop_MS) == 1 | 2 | 3:
                        print("Digitou errado, tente novamente!")
                        loop_MS = (input("\n1-Reiniciar\n2-Voltar ao Menu principal\n3-Estatísticas indiviual"))         
        case 2:
...
Outros encargos e taxas legais = 6,01%%{neutro}\n""")
                if menu_Quina == 1:
                    ...
                    if loop_Q ==1:
                        loop_Q += 1
                    loop_Q = str(loop_Q)
                    while not loop_Q.isdigit() or loop_Q == 1 | 2 | 3:
                        print("Digitou errado, tente novamente!")
                        loop_Q = (input("\n1-Reiniciar\n2-Voltar ao Menu principal\n3-Estatísticas indiviual\n"))
                    if int(loop_Q) == 3:
                        print(f"A arrecadação total do último jogo foi: {Arrecadação_total}\n")
                ...
                if menu_Quina == 2:
                    ...
                    divisão_Terno = premio_terno/terno
                    ...
                    if loop_Q ==1:
                        loop_Q += 1
                    while not loop_Q.isdigit() or loop_Q == 1 | 2 :
                        print("Digitou errado, tente novamente!")
                        loop_Q = (input("\n1-Reiniciar\n2-Voltar ao Menu principal\n3-Estatísticas indiviual"))
                    if loop_Q == 3:
                        print(f"A arrecadação total do último jogo foi: {Arrecadação_total}\n")
                        ...
                        print(f" Impostos: {imposto_Q:.2f} Reais")
                        loop_MS = (input("\n1-Reniciar\n2-(Voltar ao Menu principal)\n3-Estatísticas individuais"))
                    while not loop_Q.isdigit() or loop_MS == 1 | 2 :
                        print("Digitou errado, tente novamente!")
                        loop_MS = (input("\n1-Reiniciar\n2-Voltar ao Menu principal\n3-Estatísticas indiviual"))
        ...
        case 3:
            ...
            while int(loop_LF) == 3:
                print("-----MENU-----")
                menu_lotofácil = int(input("""1-lotofácil \n2-lotofácil da independência\n"""))
...
Outros encargos e taxas legais = 12,66%%{neutro}\n""")
                if menu_lotofácil == 2:
                    Concursos_LF += 1
                    Valor_aposta_LF = float(input("Informe o valor de uma aposta na Lotofácil da independência:")) #Registro do valor de uma aposta.
                    ...
                    arrecadação = Valor_aposta_LF * quantidade_apostas
                    ...
                    for premiação in range(1,4,+1):                                               # Estrutura de repetição para registrar a quantidade de ganhadores.
                        if premiação == 1:
                            Princial = int(input("Digite a quantidade de ganhadores do prêmio princial:"))

                        elif premiação == 2:
                            Fixo = int(input("Digite a quantidade de ganhadores do prêmio Fixo: "))
                        
                    Divisão_Princial = Premio_principal/Princial
                    Divisão_Fixo = Premio_Fixo/Fixo
                    ...
                    print(f" Seguridade Social {Seguridade_social:.2f} Reais")
                    print(f" Fundo Nacional de Cultura {fnc:.2f} Reais")
                    print(f" Comite Olímpico e Paralímpico: {Comite_Olimpico_Paralimpico:.2f} Reais")
                    print(f" Fundo Penintenciário Nacioal: {funpen:.2f} Reais")
                    print(f" Fundo Nacional De Segurança Pública: {fnsp:.2f} Reais")
                    print(f" Custos Operacionais: {Custos_Operacionais:.2f} Reais")
                    print(f" Impostos: {imposto:.2f} Reais")

                    loop_LF = int(input("\nDeseja Refazer alguma Lotofácil?\n1-(Sim)\n2-(Voltar ao Menu principal)\n"))  
                    if loop_LF ==1:
                        loop_LF += 2  
                ...
                if menu_lotofácil == 2:
                    Concursos_LF += 1
                    Valor_aposta_LF = float(input("Informe o valor de uma aposta na Lotofácil:")) #Registro do valor de uma aposta.
                    quantidade_apostas = int(input(" Digite quantas apostas foram realizadas: ")) #Quantidade de apostas registradas.
                    ...
                    for premiação in range(1,3,+1):                                               # Estrutura de repetição para registrar a quantidade de ganhadores.
                        if premiação == 1:
                            Princial = int(input("Digite a quantidade de ganhadores do prêmio princial:"))
        ...
        case 4:
            ...
            menu_estatísticas = int(input("1-Mega Sena\n2-Quina\n3-Lotofácil"))
            if menu_estatísticas == 1:
                print("---Estatísticas Gerais da Mega Cena---")
            if menu_estatísticas == 2:
                print("---Estatísticas Gerais da Quina---")
            if menu_estatísticas == 3:
                print("---Estatísticas Gerais da Lotofácil1---")
    loop = menu_inicial
